...
class MinimizeFCNAxialVector : public ROOT::Minuit2::FCNBase
{
    ...
    */
        ...
        if(new_method)
        {
            ...
            const Int_t NUM_BINS_XY = 50 * number1DHists + 50 * 50 * number2DHists;
            if(V_CHEN == nullptr)
            {
            ...
            if(V_STAT == nullptr)
            {
                std::cout << "Alloc V_STAT" << std::endl;
                V_STAT = new TH2D("V_STAT", "V_STAT",
                                  NUM_BINS_XY, 0.0, NUM_BINS_XY,
                                  NUM_BINS_XY, 0.0, NUM_BINS_XY);
            }
            if(V_SYS == nullptr)
            {
                std::cout << "Alloc V_SYS" << std::endl;
                V_SYS = new TH2D("V_SYS", "V_SYS",
                                  NUM_BINS_XY, 0.0, NUM_BINS_XY,
                                  NUM_BINS_XY, 0.0, NUM_BINS_XY);
            }
            if(D == nullptr)
